...
# You will have to complete a function that take an array of events in arguments, according to this list you will 
# return the number of coffee you need to stay awake during day time. 
...
def how_much_coffee(events)
  count = 0
  events.each do |i|
    count += 1 if !!i.match(/(cw\z)|(cat)|(dog)|(movie)/)
    count += 2 if !!i.match(/(CW)|(CAT)|(DOG)|(MOVIE)/)
  end
